...
function gotData(data) {
  ...
  var now = queryResult.hourly.data[0];
  var hour1 = queryResult.hourly.data[1];
  var hour2 = queryResult.hourly.data[2];
  var hour3 = queryResult.hourly.data[3];
  var hour4 = queryResult.hourly.data[4];
  var hour5 = queryResult.hourly.data[5];
  var hour6 = queryResult.hourly.data[6];
  var hour7 = queryResult.hourly.data[7];
  var hour8 = queryResult.hourly.data[8];
  var hour9 = queryResult.hourly.data[9];
  var hour10 = queryResult.hourly.data[10];
